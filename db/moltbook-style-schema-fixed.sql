-- Moltbook-style forum schema (fixed)

-- Add karma to users
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS karma INTEGER DEFAULT 0;

-- Drop old tables if they conflict
...
CREATE TABLE IF NOT EXISTS votes (
    ...
    CONSTRAINT vote_comment_unique UNIQUE(user_id, comment_id),
...
CREATE INDEX IF NOT EXISTS idx_submolt_members_user ON submolt_members(user_id);
